 ...
 * If issue Still Exist, below try edit $sync_adv_cache_path to load in plugin to file ./includes/load/advanced-cache.php
 *
...
define( 'WSYNC_ADV_CACHE_PRESENT', true );

$sync_adv_cache_data = '{"test":"test"}';

// Path to Load File.
$sync_adv_cache_path = '/mnt/windows-data/Users/shub/shubham/code/wp/sync/app/public/wp-content/plugins/wisesync/includes/load/advanced-cache.php';

// Load Main Mu-Plugin File.
if ( file_exists( $sync_adv_cache_path ) ) {
	require_once $sync_adv_cache_path;
} else {
	...
	add_filter(
		...
		function ( $admin_notice_callbacks ) {
			global $sync_plugin;
			// Append Call back.
			$admin_notice_callbacks[] = array( $sync_plugin, 'sync_adv_cache_on_error' );
